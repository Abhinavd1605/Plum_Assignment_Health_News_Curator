...
export const ProcessingHub: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 overflow-hidden">
      {/* Professional Header */}
      <header className="w-full bg-white/90 backdrop-blur-lg border-b border-gray-200/50 shadow-sm flex-shrink-0">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 lg:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 lg:space-x-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-white rounded-xl shadow-sm border border-gray-200 relative">
                <img src="/logo.svg" alt="Health News Curator" className="absolute inset-0 w-6 h-6 lg:w-8 lg:h-8 m-auto" />
              </div>
              <div>
                <h1 className="text-lg lg:text-2xl font-bold text-gray-900">AI Processing Hub</h1>
                <p className="text-xs lg:text-sm text-gray-600 hidden sm:block">Real-time Medical Content Analysis</p>
              </div>
            </div>
      ...
      <div className="flex-1 container mx-auto px-4 lg:px-8 py-4 lg:py-6 overflow-hidden">
        <div className="h-full grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-4">
          ...
          <div className="lg:col-span-3 flex lg:flex-col gap-3 lg:gap-4 lg:max-h-full lg:overflow-y-auto">
            {/* Doctor Animation */}
            <div className="flex-1 lg:flex-none bg-white/80 backdrop-blur-xl rounded-2xl p-3 lg:p-5 shadow-2xl border border-white/50">
              <div className="text-center space-y-2 lg:space-y-3">
                <div className="w-32 h-32 lg:w-48 lg:h-48 xl:w-56 xl:h-56 mx-auto relative">
                ...
                <div className="space-y-1">
                  <h3 className="text-sm lg:text-xl font-bold text-gray-900">Medical AI</h3>
                  <p className="text-xs text-gray-600 hidden lg:block">Advanced Processing Engine</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex lg:flex-col gap-2 lg:gap-3 flex-1 lg:flex-none">
              <div className="flex-1 lg:flex-none bg-white/80 backdrop-blur-xl rounded-xl p-2 lg:p-4 shadow-xl border border-white/50">
                <div className="flex lg:flex-row items-center lg:space-x-3">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="text-sm lg:text-xl font-bold text-gray-900">{state.articles.length}</div>
              ...
              <div className="flex-1 lg:flex-none bg-white/80 backdrop-blur-xl rounded-xl p-2 lg:p-4 shadow-xl border border-white/50">
                <div className="flex lg:flex-row items-center lg:space-x-3">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="text-sm lg:text-xl font-bold text-gray-900">{processedCount}</div>
          ...
          <div className="lg:col-span-6 flex flex-col justify-center flex-1">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 lg:p-8 shadow-2xl border border-white/50 flex flex-col justify-center min-h-[300px] lg:min-h-[400px]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 lg:space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700 font-medium text-xs lg:text-base">Processing Progress</span>
                    ...
                    <div className="relative h-3 lg:h-5 bg-gray-200 rounded-full overflow-hidden">
                      <div 
                        className="absolute inset-y-0 left-0 bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 rounded-full transition-all duration-1000 ease-out"
          ...
          <div className="lg:col-span-3 flex flex-col max-h-full overflow-y-auto">
            <h3 className="text-base lg:text-xl font-bold text-gray-900 mb-2 lg:mb-3">Processing Pipeline</h3>
            
            <div className="space-y-2 flex-1 grid grid-cols-2 lg:grid-cols-1 lg:space-y-3 gap-2 lg:gap-0">
              {processingSteps.map((step, index) => (
                <div 
                  key={index}
                  className={`bg-white/80 backdrop-blur-xl rounded-xl p-2 lg:p-4 shadow-lg border transition-all duration-500 ${
                    step.completed 
                ...
                >
                  <div className="flex lg:flex-row items-start space-x-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">
                        {step.title}
                      </h4>
                      ...
                      {step.completed && (
                        <div className="mt-1 flex items-center space-x-1">
                          ...
                          <span className="text-xs text-green-600 font-medium hidden lg:inline">Completed</span>
                        </div>
                      )}
                    </div>
                  </div>
        ...
        {state.processingState.progress === 100 && (
          <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-2xl text-center text-white max-w-md mx-4">
              <div className="space-y-4 lg:space-y-6">
                ...
                <button
                  ...
                  className="bg-white text-green-600 px-6 lg:px-8 py-3 lg:py-4 rounded-xl lg:rounded-2xl font-bold text-base lg:text-lg hover:bg-green-50 transition-all duration-300 flex items-center justify-center gap-2 lg:gap-3 mx-auto group shadow-xl"
                >
